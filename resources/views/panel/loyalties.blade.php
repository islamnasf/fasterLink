          ...
          <div class="card-body">
            <table id="data-table" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                <td>{{$loyalty->store->loyalty_type}}</td>
                <td>{{$loyalty->points}}</td>
                <td>{{($loyalty->store->loyalty_type == "product")?$loyalty->store->loyalty_product_points:$loyalty->store->loyalty_invoice_amount}}</td>
                <td>{{$loyalty->store->loyalty_expired}}</td>
                <td>{{$loyalty->store->brand_name}}</td>
                <td>
